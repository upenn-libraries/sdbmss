...
#      config.add_facet_field 'provenance_place', :label => 'Provenance Place', :limit => 3
...
#      end
      ...
      config.add_sort_field 'catalog_or_lot_number_sort asc', :label => 'Catalog/Lot Number (asc)'
      config.add_sort_field 'catalog_or_lot_number_sort desc', :label => 'Catalog/Lot Number (desc)'
...
#      config.add_results_collection_tool(:save_current_search)
      ...
      config.add_show_tools_partial(:email, path: 'catalog_email_path', if: false)
      config.add_show_tools_partial(:sms, path: 'catalog_sms_path', if: false)
