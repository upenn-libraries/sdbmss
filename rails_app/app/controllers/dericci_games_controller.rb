class  DericciGamesController < ApplicationController
  ...
  def update
    ...
    flash[:success] = '<span class="fa fa-building"></span><span class="fa fa-chess-bishop"></span><span class="fa fa-chess-queen"></span><span class="fa fa-chess-pawn"></span>Thank you for playing the Dericci Archives Game!'.html_safe
    respond_to do |format|
